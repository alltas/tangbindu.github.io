...
function findIcon(cvs,piex2D,fixed){
  ...
  function findIconBox(num){
    ...
    //util.show2D(box.data)
    // for (var y = 0; y < box.data.length; y++) {
    //     var val=-1;
    //     for (var x = 0; x < box.data[y].length; x++) {
    //       val=box.data[y][x]==num ? ++val : val;
    //       if(val%2==0 box.data[y][x]){
    //         box.data[y][x]=num; 
    //       }
    //       //box.data[y][x]=box.data[y][x]==1 ? val : box.data[y][x];
    //         // try{
    //         //     if (box.data[y][x-1]> && box.data[y][x]==1) {
    //         //         box.data[y][x]=box.data[y][x-1];
    //         //         val=box.data[y][x-1];
    //         //     }
    //         // }catch(err){}
    //     }
    ...
    //     for (var x = 0; x < box.data[y].length; x++) {
    //         try{
    //             if (box.data[y][x-1]>1 &&  box.data[y][x]>0) {
    //                 box.data[y][x]=box.data[y][x-1];
    //             }
    //         }catch(err){}
    //     }
    // }
    // for (var y = 0; y < box.data.length; y++) {
    //     for (var x = box.data[y].length-1; x >-1;x--) {
    //         try{
    //             if (box.data[y][x]>1 &&  box.data[y][x-1]>0) {
    //                 box.data[y][x-1]=box.data[y][x];
    //             }
    //         }catch(err){}
    //     }
    // }
